...
DROP TABLE IF EXISTS bakery_security_logs;
CREATE TABLE IF NOT EXISTS bakery_security_logs (
	id	INTEGER,
	year	INTEGER,
	month	INTEGER,
	day	INTEGER,
...
INSERT INTO crime_scene_reports (id,year,month,day,street,description) VALUES (1,2021,1,1,'Chamberlin Street','Credit card fraud took place at 00:53. Two people witnessed the event.'),
 ...
 (295,2021,7,28,'Humphrey Street','Theft of the fiftyville duck took place at 10:15am at the Humphrey Street bakery. Interviews were conducted today with three witnesses who were present at the time – each of their interview transcripts mentions the bakery.'),
